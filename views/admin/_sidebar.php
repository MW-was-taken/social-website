<div class="admin-sidebar">
  <a href="/admin"><i class="fa-solid fa-house-chimney"></i>Dashboard</a>
  <a class="no-hover"><i class="fa-solid fa-gear"></i>Site Settings<i class="fa-solid fa-caret-down caret"></i></a>
